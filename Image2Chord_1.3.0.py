"""Image to Chord 1.3.0 - Convert images to chords.
...
def create_app_window():
    ...
    chord_display_label.place(x=25,y=268,width=200)
...
def get_palette():
    ...
    indexed_img.save("indexed.png",format="png")
    pal = Image.open("indexed.png")
    pal=pal.convert("P",colors=notes_number,palette=Image.Palette.ADAPTIVE)
    palcol=pal.palette.colors
    #print (palcol)
    palcol2 = {}
